...
import { DisplayProdComponent } from './display-prod/display-prod.component';
import { FooterComponent } from "./footer/footer.component";


@Component({
  selector: 'app-root',
  imports: [CurrencyPipe, DisplayProdComponent, CommonModule, FooterComponent],
  templateUrl: './app.component.html',
  styleUrl: './app.component.css'
})
export class AppComponent {
  title = 'pruebas-sprint3';

  vista:boolean=true; 

  fndisplayNew(valor:boolean){
    this.vista=valor; 
